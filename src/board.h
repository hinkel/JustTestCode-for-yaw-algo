...
// #define RADX100         M_PI / 18000.0f
// #define RADtoDEG     180.0f  / M_PI
// #define RADtoDEG10  1800.0f  / M_PI
// #define RADtoDEG100 18000.0f / M_PI



// Precalculated is better for gcc
#define RADX        0.017453292519f
#define RADX10      0.001745329252f
#define RADX100     0.000174532925f
#define RADtoDEG    57.29577951308f
#define RADtoDEG10  572.9577951308f
#define RADtoDEG100 5729.577951308f
...
// max. number of supported channels 10 Aux + 4 (roll pitch yaw thr)
#define MAX_RC_CHANNELS 10    // Limit to 10 Channels 4 + 6 NOTE: DONT GO BELOW 8 !!!

// max. number of monitored Motors for percentage statistic
#define MAX_MONITORED_MOTORS 8
...
// sync this with featureNames in cli.c
typedef enum
{
    FEATURE_PPM              = 1 <<  0,
    FEATURE_VBAT             = 1 <<  1,
