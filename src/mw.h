...
#define  VERSION  211
#define  FIRMWARE  "Harakiri10 SG 2.6 PID Test " __DATE__ " / " __TIME__
...
typedef struct config_t
{
    ...
    uint8_t  maincuthz;                     // (0-50Hz) 0 Disables pt1element. Cuf Off Frequency for pt2 element D term in Hz of main Pid controller
    ...
    float    acc_altlpfhz;                  // LPF in HZ just for althold
    float    acc_gpslpfhz;                  // LPF in HZ just for GPS ins stuff
...
int32_t  GPS_TargetBearing(int32_t *TrgtLAT, int32_t *TrgtLON);
